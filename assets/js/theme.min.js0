...
var formData = JSON.stringify($("#fetch").serializeArray());
  console.log(formData);

  $.ajax({
    type: "POST",
    url: "https://hooks.slack.com/services/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",
    data: formData,
    headers: {
  ...
  // var form = document.forms.namedItem("fetch");
  ...
  //   oReq.open("POST", "https://hooks.slack.com/services/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", true);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //   request.open("POST", "https://hooks.slack.com/services/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");
  //   request.send(body);
  ...
  // const postForm = (body) => {
  //   return fetch('https://hooks.slack.com/services/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', {
  //     method: 'POST',
  //     headers: {
  //       'Content-Type': 'application/json'
  //     },
